...
class MenuApp:
    ...
    def _train_tanh(self):
        ...
        y_train_norm, y_min, y_max = DataHandler.normalize_targets(y_train)
        y_test_norm = (y_test - y_min) * (0.9 - (-0.9)) / (y_max - y_min) + (-0.9)
        ...
        y_train_pred = DataHandler.denormalize_targets(y_train_norm_pred, y_min, y_max)
        y_test_pred = DataHandler.denormalize_targets(y_test_norm_pred, y_min, y_max)
